\section{The Automorphic Side}
    ...
    \subsection{Grothendieck's Sheaf-Function Correspondence and Artin Reciprocity}
        ...
        \subsubsection{The Grothendieck-Lefschetz trace formula}
            ...
            \end{lemma}
            \begin{corollary}[The trace formula for locally algebraic groups] \label{coro: the_trace_formula_for_locally_algebraic_groups}
        ...
        \subsubsection{Artin Reciprocity for global function fields over finite fields}
            ...
            \end{theorem}
                \begin{proof}
                    The existence of a canonical group isomorphism as stated comes directly from a combination of corollary \ref{coro: geometric_langlands_for_GL1} and theorem \ref{theorem: hecke_characters_from_hecke_eigensheaves}, so let us focus on the \say{Frobenius-compatibility} condition $\chi(\Frob_v) = \xi(\varpi_v)$.
                \end{proof}