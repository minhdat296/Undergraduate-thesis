    ...
    \subsection{Artin Reciprocity via traces of Frobenii}
        ...
        \subsubsection{Artin Reciprocity and class field theory for global function fields over finite fields}
            ...
            \begin{theorem}[Artin Reciprocity for global function fields over finite fields] \label{theorem: artin_reciprocity_for_function_fields_over_finite_fields}
                ...
                such that $\chi(\Frob_x) = \Artin_X(\chi)(x)$ for any $\ell$-adic character $\chi \in \Rep^{\cont, 1}_{\bar{\Q}_{\ell}}(\pi_1(X_{\fet}))$ and any closed point $x \in |X|$ (viewed as the line bundle corresponding to the effective divisor $[x] \in \Div_{X/\F_q}^{\eff, (1)}$; cf. proposition \ref{prop: symmetric_powers_of_curves_parametrise_divisors}).
            \end{theorem}
                \begin{proof}
