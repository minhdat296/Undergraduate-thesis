\section{The Automorphic Side}
    \subsection{Symmetric powers of curves, Jacobians, and the Abel-Jacobi map}
     ...
     \subsection{Hecke eigensheaves and geometric class field theory}
        ...
        \end{remark}
        Lemma \ref{lemma: hecke_eigensheaves_extend_to_lower_degrees}, which is regarding the \say{globality} of Hecke eigensheaves is merely a technicality in service of theorem \ref{theorem: unramified_abelian_geometric_class_field_theory}. The reader can safely skip ahead and refer back to it later. To be able to discuss it, however, it will be convenient to have the notion of \textbf{character sheaves} at our disposal.
