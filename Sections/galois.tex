\section{The Galois Side}
    \subsection{The \'etale fundamental group}
        ...
        \begin{proposition}[Functoriality of the \'etale fundamental group] \label{prop: etale_fundamental_group_functoriality}
        ...
        \end{proposition}
            ...
            \end{proof}
        \begin{corollary}[The \'etale Eckmann-Hilton Duality] \label{coro: etale_eckmann_hilton_duality}
