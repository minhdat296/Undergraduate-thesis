\section{The Galois Side}
    \subsection{The \'etale fundamental group}
        \begin{definition}[Galois categories and their fundamental groups] \label{def: finite_galois_categories}
            ...
            \end{enumerate}
        \end{definition}
        \begin{remark}[Some basic properties of Galois categories] \label{remark: basic_properties_of_galois_categories}
        ...
        Before we state the next definition, let us observe that for any given base scheme $X$, the category $(\Sch_{/X})_{\fet}$ of schemes finite and \'etale over $X$ is a category wherein:
            \begin{itemize}
